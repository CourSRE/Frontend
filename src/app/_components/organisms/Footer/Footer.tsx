...
export const Footer: React.FC<TProps> = () => {
  return (
    <footer>
      <section className="py-[26px] bg-primary-base text-white">
            ...
            <section key={section.name} className="flex-1 flex flex-col gap-5">
              ...
              <ul className="text-sm">
                {section?.items?.map((nav) => (
                  <li key={`footerNavLink-${nav?.name}`} className="py-[6px] flex gap-3">
      ...
      <section className="bg-gray-100 text-primary-base py-6">
